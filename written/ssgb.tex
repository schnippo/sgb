...
\section{Motivation KÖNNTE ICH VERSCHIEBEN, UM DEN TROCKENEN, TECHNISCHEN TEIL AUFZUFRISCHEN}
\subsection{Was mich inspiriert}
Ich verbringe (zu) viel Zeit auf YouTube. Dort beriesle ich mich Videos, welche mich nicht selten recht inspirieren, eine Gattung davon sind alle Videos, welche sich mit Offgrid-Versorgungssystemen beschäftigen, also der Nahrungs-/Energieversorgung eines Lebensraums ohne am Hauptnahrungs-/energienetz angeschlossen zu sein. Dieses Autarksein fasziniert mich. Des weiteren stiess ich vor etwa 10 Monaten auf den Kanal von Jeb Gardener. Ich fasse die Gemeinsamkeiten seiner Videos im folgenden Satz zusammen: Verrückter Gärtner züchtet mit komplett unkonventionellen und (laut einigen Stimmen seitens des \textit{traditionellen Gärtnermilieus}) ethisch kritischen Methoden Pflanzen. Seine Bewässerungsmethoden sind überaus selten traditionell, bedeutet, dass er fast immer auf Erde verzichtet. Er stellt die Pflanzen direkt ins Wasser. Beleuchtet wird künstlich, mit pinken LEDs und die Nährstoffe sind synthetisiert und werden einfach ins Wasser geworfen, woe sie sich auflösen. Konventionalität interessiert ihn nicht. Dazu kommt noch, und das ist fast das Beste, dass seine Videos durch die musikalisch Begleitung von epischer Orchestermusik eine fast zerreissende Spannung erreichen. Stellen Sie sich einen durchgeknallten Gärtner vor, der von einem Streichorchester begleitet, Wurzeln filmt.

Papa, Segeln, Offgrid, Homestead, Rob Greenfield, Jeb Gardener, Solar, Tinkering.
Ich mach das nicht \textit{nur} als Maturarbeit
