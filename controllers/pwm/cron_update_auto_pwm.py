...
from classes import get_prop_value, update_prop, avg_lastNlines

if get_prop_value("pwm_mode") == "manual":
    print("pwm_mode is on manual, exiting..")
    exit()

AT_LOG_PATH = "/home/jonas/git/ssgb/controllers/pwm/logs/at_log"
# AH_LOG_PATH = "/home/jonas/git/ssgb/controllers/logs/ah_log"
...
curr_temp = avg_lastNlines(AT_LOG_PATH, int(get_prop_value("auto_update_reference"))) # get the last 5 minutes of temp values
# curr_hum = avg_lastNlines(AH_LOG_PATH, get_prop_value("auto_update_reference")) # get the last 5 minutes of hum values
...
update_prop("pwm_dutycycle", str(new_pwm)) # write it to properties.
